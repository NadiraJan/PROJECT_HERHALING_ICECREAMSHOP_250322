...
public class IceCreamCar implements IceCreamSeller {
    ...
    public IceRocket orderIceRocket() throws NoMoreIceCreamException {
        IceRocket iceRocket = prepareIceRocket(); // public methode voor de klant
    ...
    public Magnum orderMagnum(Magnum.MagnumType type) {
        Magnum magnum = new Magnum(); // public methode voor de klant
        profit += priceList.getStandardMagnumPrice(type);
